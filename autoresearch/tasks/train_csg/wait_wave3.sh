#!/bin/bash
# Block until all 8 wave-3 runs print a final summary (^hard_dice:) or die.
logs=(w3_md_m001 w3_md_m0 w3_md_mn01 w3_md_mn02 w3_md_mn03 w3_md_m0_wr3 w3_md_mn01_wr3 w3_md_mn01_rev24)
declare -A done
while true; do
  alldone=1
  for f in "${logs[@]}"; do
