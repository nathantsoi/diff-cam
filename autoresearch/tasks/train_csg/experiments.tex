...
$22.86~\mathrm{mm}$-radius target. Mid-training signal (iteration $\approx 1000$)
shows the $k$-anneal win transfers: sphere $k{=}10$ stalls at $\approx 0.55$
whereas the full method reaches $\approx 0.77$ and is still climbing. The gap is
consistent with the $1~\mathrm{in}$ result, indicating the method is not tuned to
a single absolute scale. Final-seed runs are in progress at the time of writing.
