#!/bin/bash
# Block until all 8 wave-2 runs print a final summary (^hard_dice:) or die.
logs=(w2_md_default w2_md_feed60 w2_md_feed60_tight w2_md_feed60_rev24 w2_md_feed60_lvl10 w2_md_feed60_tg w2_md_feed60_shift w2_raster_tg)
declare -A done
while true; do
  alldone=1
  for f in "${logs[@]}"; do
