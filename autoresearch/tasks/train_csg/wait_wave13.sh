#!/bin/bash
# Block until all 8 wave-13 runs print a final summary (^hard_dice:) or die.
cd "$(dirname "$0")"
logs=(w13_bowl_k70_wg6b w13_bowl_k70_wg4 w13_sph_k90 w13_pyr_k90 w13_bowl_k90_wg6 w13_hole_k70_8k w13_pyr_k70_8k w13_hole_k90)
declare -A done
while true; do
  alldone=1
  for f in "${logs[@]}"; do
